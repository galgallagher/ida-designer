...
/**
 * IdaPanel — the heavy chat panel for the Ida assistant.
 *
 * Lazy-loaded by IdaWidget on first open so its dependencies
 * (Vercel AI SDK, SpecDetailModal, message renderers) stay out of the
 * initial bundle for users who never click the bubble.
 *
 * Owns all chat state and the spec-detail modal triggered from chat.
 * The bubble button itself lives in IdaWidget and is always rendered.
 */
...
export default function IdaPanel({
  open,
  onClose,
  projectId,
  projectName,
