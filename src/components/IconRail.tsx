 ...
 *
 * Uses shadcn Tooltip to label icons when the rail is collapsed.
 */
      ...
      >
        ...
        <nav className="flex flex-col gap-0.5 flex-1 px-2">
          {visible.map((item) => {
            ...
            return (
              <Tooltip key={item.href} open={expanded ? false : undefined}>
                ...
                <TooltipContent side="right" style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: 12 }}>
                  {item.label}
                </TooltipContent>
              </Tooltip>
            );
